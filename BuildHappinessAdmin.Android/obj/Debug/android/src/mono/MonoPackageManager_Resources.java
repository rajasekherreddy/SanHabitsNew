...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "BuildHappinessAdmin.Android.dll" comes first in this list. */
		"BuildHappinessAdmin.Android.dll",
		"BuildHappiness.Core.dll",
		"Acr.UserDialogs.dll",
		"AndHUD.dll",
		"BuildHappinessAdmin.dll",
		"Firebase.Auth.dll",
		"Firebase.dll",
		"FormsViewGroup.dll",
		"LiteDB.dll",
